...
# Laad de data
trein_data = pd.read_csv("../../Data/outputs/test/output_Holland_7775.714285714286.csv")
stations_data = pd.read_csv("../../Data/StationsHolland.csv")
...
# Sla de kaart op
trein_kaart.save("../kaart_lijnvoering.html")
